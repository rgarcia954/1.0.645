...
unsigned int adc_threshold = ADC_THRESHOLD_VALUE;
unsigned int diff_mode = SENSOR_DIFF_MODE;
...
void Sensor_Init(void)
{
    uint32_t sensor_cfg = SENSOR_ENABLED |
                          ...
                          SENSOR_IOFFSET_20NA |
                          SENSOR_IRANGE_80NA |
#else    /* if SENSOR_CALIB == 1 */
                          SENSOR_CALIB_DISABLED |
                          SENSOR_IOFFSET_0NA |
                          SENSOR_IRANGE_240NA |
#endif    /* if SENSOR_CALIB == 1 */
                          SENSOR_AMP_ENABLED;
