 ...
 *   - RTC_ALARM_ZERO
 *   - etc. */
#define RTC_ALARM_DURATION              RTC_ALARM_125MS
 ...
 *   - etc. */
#define FIFO_SIZE_VALUE                 SENSOR_FIFO_SIZE4
 ...
 *   - etc. */
#define PULSE_COUNT_INT_VALUE           PULSE_COUNT_INT_0
 ...
 *   - etc. */
#define DLY1_WE_L_VALUE                 ((uint32_t)(0x3FF << SENSOR_DELAY_L_CFG_DLY1_WE_L_Pos))
 ...
 *   - etc. */
#define IDLE_TIME_VALUE                 ((uint32_t)(0x77FF << SENSOR_IDLE_CFG_IDLE_TIME_Pos))
